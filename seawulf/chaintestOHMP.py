...
import sys
# sys.stdout = open('writingFilesOhio.txt', 'a')
...
STEPS = 5000
ENSEMBLE_SIZE = 50
FILENAME = "./OHPrecinctsTest.geojson"
CORES = 6
...
def export_plan(initPart, partition, precincts, desc):
    ...
    for key, value in OH_INC_PREC.items():
...
def reComTime():
    ...
    badNums = {6, 15, 23, 27, 54, 57, 63, 81, 88, 248, 373, 406, 415, 423, 427, 438, 454, 457, 463, 481, 488, 648, 683, 773, 860}
